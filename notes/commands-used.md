...
## 1️⃣ System & Hostname Configuration
...
hostnamectl status
2️⃣ Hosts File Configuration
Edit /etc/hosts
nano /etc/hosts
Example entry added
173.249.31.162 vibinsec.live mail
3️⃣ iRedMail Installation
...
4️⃣ TLS Certificate (Let’s Encrypt)
Install Certbot
apt update
...
5️⃣ Postfix (SMTP) Configuration
...
6️⃣ Dovecot (IMAP) Configuration
